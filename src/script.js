...
$(document).on('click', "a#dogeTipStatus", function() {
  ...
  $(this).replaceWith("<form id='dogeStatusForm' action=" + action +  " method='post'><input type='text' name='amount'/><input type='hidden' name='sender_user_id' value='" + sender + "'/><input type='hidden' name='recipient_user_id' value='" + recipient + "'/></form>");
